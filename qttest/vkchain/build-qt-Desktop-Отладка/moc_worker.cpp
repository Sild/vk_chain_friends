...
QT_MOC_LITERAL(8, 66, 4)
    ...
    "Worker\0finished\0\0finded\0catchFriends\0"
    "QNetworkReply*\0reply\0process\0stop\0"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finded(); break;
        case 2: _t->catchFriends((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        ...
        {
            typedef void (Worker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::finded)) {
                *result = 1;
            }
        }
    }
